...
EventKind = Literal[
    ...
    "goal_interpreted", "plan_created", "inspection_result",
    "clarification_required", "permission_required", "troubleshoot_step",
    "verification_result", "voice_audio", "mode_change",
]
